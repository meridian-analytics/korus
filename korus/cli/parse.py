...
def parse_float(answers, current, required=False, return_bool=False):
    if required and current == "":
        raise inquirer.errors.ValidationError("", reason="A non-null value is required for this field.")    
    ...
    try:
        ...
        raise inquirer.errors.ValidationError("", reason="Invalid input. Please enter a valid floating-point number.")    
...
def parse_int(answers, current, required=False, return_bool=False):
    ...
    try:
        ...
        raise inquirer.errors.ValidationError("", reason="Invalid input. Please enter a valid integer number.")    
...
def parse_datetime(answers, current, required=False, return_bool=False):
    ...
    raise inquirer.errors.ValidationError("", reason=f"Invalid input. Please enter a valid date-time as {DATETIME_FORMAT}")    
